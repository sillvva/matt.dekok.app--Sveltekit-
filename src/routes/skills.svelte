...
<Article class="w-full sm:w-8/12 md:w-10/12 lg:w-9/12">
  <ArticleSection>
    <p>
      The following are personal measurements based on years of experience and the amount of
      dedication to the subject over those years. They reflect my confidence in my abilities with
      the subject.
    </p>
  </ArticleSection>
